public class Height {
    ...
    public int[] getRandomArray(int startRange, int endRange, int size) {
        ...
        for (int counter = 0; counter < size; counter++) {
            array[counter] = (int)(Math.random()*(endRange - startRange)) + startRange;
        }
        return array;
    }

    // to get the sum of all the elements in array
    ...
    // to find the minimim number in array
    ...
    // to find the maximum number in random
