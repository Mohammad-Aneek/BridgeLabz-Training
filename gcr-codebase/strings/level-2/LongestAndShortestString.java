...
public class StringSplitWithLength {
    ...
    public static int[] getShortestAndLongest(String[][] array) {
        int shortIndex = 0, longIndex = 0;
        int size = array.length;
        for (int i = 0; i < size; i++) {
            if (Integer.parseInt(array[i][1]) < Integer.parseInt(array[shortIndex][1])) {
                shortIndex = i;
            }
    ...
    public static void main(String[] args) {
        ...
        int[] shortAndLong = getShortestAndLongest(result);
        System.out.println("The shortest is " + words[shortAndLong[0]]);
        System.out.println("The longest is " + words[shortAndLong[1]]);
    }
}
